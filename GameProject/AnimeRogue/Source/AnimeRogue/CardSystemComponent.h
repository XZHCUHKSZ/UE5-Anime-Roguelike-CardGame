...
class ANIMEROGUE_API UCardSystemComponent : public UActorComponent
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable)
    bool TryPlayCard(int32 HandIndex, int32 CurrentEnergy, int32& OutCost);
...
private:
    ...
    int32 ResolveCardCost(const FRuntimeCard& Card) const;
};
